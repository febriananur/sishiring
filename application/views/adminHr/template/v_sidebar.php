...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admin HR</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="<?= base_url('admin_hr/Dashboard')?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin_hr/promosi')?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?= base_url('admin_hr/informasi')?>" class="nav-link">
